...
public interface LalaAdminService {
	...
	//회원계정
	public int getMemberTotalCount(PagingBean pagingBean); //관리자 카운트 (페이징 때문에 필요)
	public List<MemberDto> getMemberList(PagingBean pagingBean); //관리자리스트
