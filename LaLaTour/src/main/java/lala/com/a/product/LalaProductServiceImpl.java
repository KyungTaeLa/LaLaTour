...
public class LalaProductServiceImpl implements LalaProductService {
	...
	public List<OrderedDto> getSellList(PagingBean pagingBean) {
		// 과거 주문내역
		return lalaProductDao.getSellList(pagingBean);
	}
