...
public class DownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(
		...
		String pampletAf = (String)model.get("pampletAf");
		String pampletBf = (String)model.get("pampletBf");
		if(ie) {
		...
		response.setHeader("Content-Disposition", "attachment; filename=\"" + pampletBf + "\";");
		...
		System.out.println("파일 다운로드 : "+ request.getSession().getServletContext().getRealPath("/upload")+pampletBf);
