...
<br>
         ...
         <c:forEach items="${attrlist }" var="attr" varStatus="status">
            ...
            <td>
               <figure class="snip1382">
                  ...
                  <a class="ac" href="location_food_detail.do?seq=${attr.seq }"> <img
                     alt="이미지없음"
   ...
   <jsp:include page="paging.jsp">
      <jsp:param name="actionPath" value="location_food.do" />
...
<script type="text/javascript">
   function gowrite() {
      ...
      location.href = "location_food_write.do";
   ...
   function _btnSearch() {
      ...
      location.href = "location_food.do?findWord=" + findWord + "&choice="
            + choice;
   }
