...
<form id="wfrm" enctype="multipart/form-data" action="location_shop_updateAf.do?seq=${attupdate.seq }&subname=${attupdate.subname }" method="post" onsubmit="return sub()">
<table id="writeT">
<tr>
   <th>제목 : </th>
   <td>
...
function sub() {
 ...
 /* function _deleteFile( obj ) {
   var str = $("#bfile").val();
   alert("function :" + obj.value);attrac
   $.ajax ({
