...
<%-- 
<img src="<%=request.getContextPath()%>/resources/images/loc_E.png"
   class="topimg">
    --%>
...
<div>
   <table class="st">
      <tr>
         ...
         <td style="padding-left: 5px"><span class="button blue">
               <button type="submit" id="_btnSearch" onclick="_btnSearch()">검색</button></td>
               <td>
   ...
   <%-- <form id="attfrm" name="_attfrm">
      <input type="hidden" name="subname" value="attrac">
      ...
      <table class="lt">
            ...
            <tr class="listtdc">
               <c:forEach items="${attrlist }" var="attr" varStatus="status">
                  <c:if test="${attr.del eq 0 }">
                     <td align="center"><div class="view overlay zoom">
                           <a href="location_attrac_detail.do?seq=${attr.seq }"> <img
                              alt="이미지없음"
                              src="<%=request.getContextPath() %>/upload/${attr.thumbnail }"
                              style="width: 260px; height: 260px" class="img-fluid "
                              alt="smaple image"></a>
                           <div class="mask flex-center">
                              <a href="location_attrac_detail.do?seq=${attr.seq }"><p
                                    class="white-text">${attr.title }</p></a>
                           </div>
                        </div></td>
         ...
         <tr>
            <td><input type="hidden" id="loginid" value="${login.id }">
               ...
               <input type="button" id="wbtn" onclick="gowrite()" value="글쓰기"></td>
         </tr>
      </table>
   </form> --%>
         ...
         <c:forEach items="${attrlist }" var="attr" varStatus="status">
            ...
            <td>
               <figure class="snip1382">
                  ...
                  <a class="ac" href="location_attrac_detail.do?seq=${attr.seq }"> <img
                     alt="이미지없음"
                     src="<%=request.getContextPath() %>/upload/${attr.thumbnail }"
                     style="width: 260px; height: 260px" class="img-fluid "
                     alt="smaple image">
   ...
   <jsp:include page="paging.jsp">
      <jsp:param name="actionPath" value="location_attrac.do" />
...
<script type="text/javascript">
   function gowrite() {
      ...
      location.href = "location_attrac_write.do";
   }
   ...
   function _btnSearch() {
      ...
      location.href = "location_attrac.do?findWord=" + findWord + "&choice="
            + choice;
   }
