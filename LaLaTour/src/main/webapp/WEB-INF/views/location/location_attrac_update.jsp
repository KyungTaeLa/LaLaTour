...
<form id="wfrm" enctype="multipart/form-data" action="location_attrac_updateAf.do?seq=${attupdate.seq }&subname=${attupdate.subname }" method="post" onsubmit="return sub()">
<table id="writeT" st>
<tr>
   <th>제목 : </th>
   <td>
...
<tr class="Ofile">
   <th>썸네일 원본 : </th>
   <td><img alt="이미지없음"  src="<%=request.getContextPath()%>/upload/${attupdate.thumbnail }" style="word-spacing: 200px;height: 200px;"> 
      ...
      <input type="button" name="changefile" style="" onclick="changeT()" id="changefile" class="myButton5" value="변경">
   </td>
</tr>
