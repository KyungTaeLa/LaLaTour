...
<tr>
  <td>
	...
	<form action="location_attrac_update.do" id="detailfrm">
...
<!-- 댓글 쓰기 -->
<form action="location_attrac_Reply.do" onsubmit="return writeRep()">
...
<table style="margin-left: 465px;">
	...
	<c:forEach items="${rlist }" var="rep" varStatus="status">
		...
		<!-- 정상 댓글 -->
		<form action="location_attrac_upreply.do">
		...
		<!-- 대댓글 쓰기 -->
		<form action="location_attrac_SubreplyAf.do"
		...
		<!-- 댓글 수정 -->
		<form action="location_attrac_Replyupdate.do" onsubmit="return repupdate()">
		<div class="inputReply">
		...
		<!-- 대댓글 수정 -->
		<form action="location_attrac_Subreplyup.do"
...
<jsp:include page="paging.jsp">
	<jsp:param name="actionPath" value="location_attrac_detail.do" />
...
<script>
	...
	function listdelete( obj ) {
		alert("삭제되었습니다.")
		location.href="location_attrac_listdelete.do?seq="+ obj;
	}
	// 댓글보이게
	...
	function deletebtn(seq, pseq) {
		...
		location.href = "location_attrac_Redelete.do?seq=" + seq + "&pseq="
				+ pseq;
	}
	 ...
	 function Subredelete(seq, pseq) {
			...
			location.href = "location_attrac_Subredelete.do?seq=" + seq + "&pseq="
					+ pseq;
		}
