...
System.out.println("//////////////paging.jsp의 actionPath: " + actionPath);
...
String s_search_seq = request.getParameter("search_seq");
//String search_seq = request.getParameter("search_seq");
/* int search_seq = 0;
if(request.getParameter("search_seq")!=null && !request.getParameter("search_seq").equals("") && !request.getParameter("search_seq").equals("0")) {
	search_seq = Integer.parseInt(request.getParameter("search_seq"));
} */

/* if(search_seq != 0) {
	actionPath = actionPath + search_seq;
}
System.out.println("paging.jsp의 search_seq: " + search_seq);
System.out.println("paging.jsp의 actionPath: " + actionPath); */

int search_seq = (s_search_seq == null || s_search_seq.trim().equals(""))? 0:Integer.parseInt(s_search_seq);
...
<input type="hidden" name="findWord" value="<%=findWord %>">
	...
	<input type="hidden" name="product_seq" value="<%=search_seq%>">
	<%-- <input type="hidden" name="seq" value="<%=seq%>"> --%>
	<%-- <input type="hidden" name="search_seq" value="<%=search_seq%>"> --%>
